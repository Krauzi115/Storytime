...
let allScreens = {
  ...
  'malena_intro': {
    ...
    prompts: [
      { label: 'Morgan'.red, nextScreen: 'morgan_screen' },
      { label: 'Mackenzie'.red, nextScreen: 'makenzie_screen' },
    ]
  },
  'morgan_screen': {
    type: 'multiple_choice',
    ...
    prompts: [
      ...
      { label: 'STUDD'.red, nextScreen: 'morgan_STUDD' },
    ]
  },
  'makenzie_screen': {
    type: 'multiple_choice',
    ...
    prompts: [
      ...
      { label: 'STUDD'.red, nextScreen: 'makenzie_STUDD' },
    ]
  },
  'morgan_TCBSR': {
    isEndingScreen: true,
  ...
  'jesse_intro': {
    ...
    prompts: [
      { label: 'Jesus Lezardo bat'.red, nextScreen: 'JL_screen' },
      { label: 'Tommy La Stella bat'.red, nextScreen: 'TLS_screen' },
      { label: 'Matt Chapman bat'.red, nextScreen: 'MC_screen' },
    ]
  },
  'JL_screen': {
    type: 'multiple_choice',
  ...
  'MC_SS': {
    isEndingScreen: true,
    text: 'The ghost of legendary but controversial Tigers player Ty Cobb returns from the dead and throws a pitch. You hit the ball to another surprisingly undead player Hank Greenburg. You leave the game disturbed by the rise of dead players coming back to life.',
  },
  ...
  'gun_screen': {
    ...
    text: 'You pick up the gun and kill the zombie, avoiding being eaten alive by the foul creature of the undead. You are now faced with a choice to search for your family in the house or make a run for it. Which will you choose?',
      prompts: [
        { label: 'Search for family'.red, nextScreen: 'search_screen' },
        { label: 'Leave family and exit the house'.red, nextScreen: 'leave_screen' },
      ]
  },
  'search_screen': {
    type: 'multiple_choice',
    ...
    prompts: [
      { label: 'Get in the car and drive'.red, nextScreen: 'familycar_screen' },
      { label: 'Walk down the street'.red, nextScreen: 'familyambush_screen' },
    ]
  },
  'leave_screen': {
    isEndingScreen: true,
  ...
  'familycar_screen': {
      ...
      prompts: [
          { label: 'Drive into the city to try and get supplies and search for other survivors'.red, nextScreen:'familydeath_screen' },
          { label: 'Get out of the city, with no food or water, and limited gas in your car'.red, nextScreen: 'familylive_screen' }
      ]
  },
  'familyambush_screen': {
    isEndingScreen: true,
